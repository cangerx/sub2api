...
curl -sSL https://raw.githubusercontent.com/Wei-Shaw/ccapi/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/Wei-Shaw/ccapi/releases)
