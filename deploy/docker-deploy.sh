#!/bin/bash
# =============================================================================
# CCAPI Docker Deployment Preparation Script
# =============================================================================
# This script prepares deployment files for CCAPI:
...
GITHUB_RAW_URL="${GITHUB_RAW_URL:-https://raw.githubusercontent.com/cangerx/sub2api/main/deploy}"
...
main() {
    echo ""
    echo "=========================================="
    echo "  CCAPI Deployment Preparation"
    echo "=========================================="
    echo ""
    ...
    echo ""
    echo "  3. View logs:"
    echo "     docker-compose logs -f ccapi"
    echo ""
