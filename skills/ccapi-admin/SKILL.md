...
node scripts/ccapi-admin.js accounts list
```
...
node scripts/ccapi-admin.js accounts bulk-update --ids 40,39 --json '{"concurrency":10}'
node scripts/ccapi-admin.js redeem-codes list --page-size 20
node scripts/ccapi-admin.js redeem-codes generate --json '{"count":1,"type":"balance","value":10}' --idempotency-key redeem-$(date +%s)
node scripts/ccapi-admin.js redeem-codes create-and-redeem --json '{"code":"order_123","type":"balance","value":10,"user_id":123}' --idempotency-key order-123
