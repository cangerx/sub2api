...
import (
	...
	_ "github.com/Wei-Shaw/ccapi/ent/runtime"
	...
	"github.com/Wei-Shaw/ccapi/internal/setup"
	"github.com/Wei-Shaw/ccapi/internal/web"
...
func main() {
	...
	if *showVersion {
		log.Printf("CCAPI %s (commit: %s, built: %s)\n", Version, Commit, Date)
		return
	}
