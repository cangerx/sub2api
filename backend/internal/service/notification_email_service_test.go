...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "CCAPI", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "CCAPI", "https://example.com/reset", "en-US"))
