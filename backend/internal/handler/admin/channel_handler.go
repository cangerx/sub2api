...
type channelModelPricingRequest struct {
	...
	BillingMode      string                   `json:"billing_mode" binding:"omitempty,oneof=token per_request image second segment"`
	...
	UnitSeconds      *float64                 `json:"unit_seconds" binding:"omitempty,min=0"`
