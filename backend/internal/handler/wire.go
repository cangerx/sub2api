...
import (
	...
	"github.com/Wei-Shaw/ccapi/internal/handler/admin"
	"github.com/Wei-Shaw/ccapi/internal/securityaudit"
...
func ProvideAdminHandlers(
	...
	adminVideoHandler *admin.VideoHandler,
...
func ProvideGatewayHandler(
	...
	h := NewGatewayHandler(gatewayService, openAIGatewayService, geminiCompatService, antigravityGatewayService,
		...
		errorPassthroughService, contentModerationService, userMsgQueueService, cfg, settingService, groupRouter)
