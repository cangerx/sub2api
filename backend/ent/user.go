...
// was not loaded in eager-loading.
func (e UserEdges) VideoGenerationTasksOrErr() ([]*VideoGenerationTask, error) {
	if e.loadedTypes[7] {
...
// QueryVideoGenerationTasks queries the "video_generation_tasks" edge of the User entity.
func (_m *User) QueryVideoGenerationTasks() *VideoGenerationTaskQuery {
	return NewUserClient(_m.config).QueryVideoGenerationTasks(_m)
}
