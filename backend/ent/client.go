...
import (
	...
	"github.com/Wei-Shaw/ccapi/ent/migrate"
...
type (
	hooks struct {
		...
		UserSubscription, VideoCallTemplate, VideoGenerationTask, VideoModel []ent.Hook
	}
	inters struct {
		APIKey, APIKeyGroupBinding, Account, AccountGroup, Announcement,
		AnnouncementRead, AuthIdentity, AuthIdentityChannel, BatchImageEvent,
		...
		TLSFingerprintProfile, UsageCleanupTask, UsageLog, User, UserAllowedGroup,
		UserAttributeDefinition, UserAttributeValue, UserPlatformQuota,
		UserSubscription, VideoCallTemplate, VideoGenerationTask,
		VideoModel []ent.Interceptor
	}
)
