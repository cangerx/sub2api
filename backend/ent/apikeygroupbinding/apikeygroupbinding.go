...
const (
	// Label holds the string label denoting the apikeygroupbinding type in the database.
	Label = "api_key_group_binding"
	...
	EdgeGroup = "group"
	// Table holds the table name of the apikeygroupbinding in the database.
	Table = "api_key_group_bindings"
	// APIKeyTable is the table that holds the api_key relation/edge.
	APIKeyTable = "api_key_group_bindings"
	...
	GroupTable = "api_key_group_bindings"
...
// Columns holds all SQL columns for apikeygroupbinding fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the APIKeyGroupBinding queries.
