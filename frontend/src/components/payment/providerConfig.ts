...
export const METHOD_ORDER = ['alipay', 'alipay_direct', 'wxpay', 'wxpay_direct', 'stripe', 'airwallex', 'tianque'] as const
...
export const WEBHOOK_PATHS: Record<string, string> = {
  ...
  tianque: '/api/v1/payment/webhook/tianque',
}
...
export const PROVIDER_CALLBACK_PATHS: Record<string, CallbackPaths> = {
  ...
  tianque: { notifyUrl: WEBHOOK_PATHS.tianque },
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  tianque: [
    { key: 'orgId', label: '', sensitive: false, hintKey: 'admin.settings.payment.field_tianqueOrgIdHint' },
    { key: 'mno', label: '', sensitive: false, hintKey: 'admin.settings.payment.field_tianqueMnoHint' },
    { key: 'privateKey', label: '', sensitive: true, hintKey: 'admin.settings.payment.field_tianquePrivateKeyHint' },
    { key: 'apiBase', label: '', sensitive: false, defaultValue: 'https://openapi-test.tianquetech.com', hintKey: 'admin.settings.payment.field_tianqueApiBaseHint' },
    { key: 'version', label: '', sensitive: false, defaultValue: '1.2', optional: true, hintKey: 'admin.settings.payment.field_tianqueVersionHint' },
  ],
}
