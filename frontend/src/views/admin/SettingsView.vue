                ...
                <div class="overflow-x-auto">
                  <table class="min-w-full text-sm">
                    ...
                    <tbody class="space-y-2">
                      <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'video', 'grok'] as const)" :key="p" class="align-top">
                        <td class="pr-4 py-1">
                    ...
                    <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                      ...
                      <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                          ...
                          <tbody>
                            <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'video', 'grok'] as const)" :key="`${authSource.source}-pq-${p}`" class="align-top">
                              <td class="pr-4 py-1">
                                <span class="font-mono text-xs text-gray-700 dark:text-gray-300">{{ p }}</span>
                              </td>
                              <td class="pr-4 py-1">
          ...
          <div class="card">
            ...
            <div class="space-y-4 p-6">
              ...
              <template v-if="form.payment_enabled">
                ...
                <!-- Row 4: Enabled payment types (provider badges like ccapipay) -->
                <div>
                  <label class="input-label">{{
...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/Wei-Shaw/ccapi/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/Wei-Shaw/ccapi/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/Wei-Shaw/ccapi/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/Wei-Shaw/ccapi/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
