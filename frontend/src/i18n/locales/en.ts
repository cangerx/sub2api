export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      videoModelMappingHint: 'Configure the public → upstream model name mapping here, same as chat/image accounts. Video requests resolve the upstream model via this mapping; unmapped names pass through unchanged. Pricing is configured on the Channels page.',
