...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'video' | 'grok'
...
const BADGE: Record<Platform, string> = {
  ...
  video: 'bg-rose-500/10 text-rose-600 border-rose-500/30 dark:text-rose-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  video: 'bg-rose-500/10 text-rose-600 dark:bg-rose-500/10 dark:text-rose-300',
...
const BORDER: Record<Platform, string> = {
  ...
  video: 'border-rose-500/20 dark:border-rose-500/20',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  video: 'bg-gradient-to-r from-rose-400 to-rose-500',
...
const BUTTON: Record<Platform, string> = {
  ...
  video: 'bg-rose-500 text-white hover:bg-rose-600 active:bg-rose-700 dark:bg-rose-500/80 dark:hover:bg-rose-500',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'video' || p === 'grok'
}
