...
export const BILLING_MODE_SECOND = 'second'
export const BILLING_MODE_SEGMENT = 'segment'
...
export function getBillingModeLabel(mode: string | null | undefined, t: (key: string) => string): string {
  switch (mode) {
    ...
    case BILLING_MODE_SECOND: return t('usage.billingModeSecond')
    case BILLING_MODE_SEGMENT: return t('usage.billingModeSegment')
...
export function getBillingModeBadgeClass(mode: string | null | undefined): string {
  switch (mode) {
    ...
    case BILLING_MODE_SECOND:
    case BILLING_MODE_SEGMENT: return 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-300'
