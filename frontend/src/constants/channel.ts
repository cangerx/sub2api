...
export const BILLING_MODE_SECOND = 'second' as const
export const BILLING_MODE_SEGMENT = 'segment' as const
export type BillingMode =
  | typeof BILLING_MODE_TOKEN
  | typeof BILLING_MODE_PER_REQUEST
  | typeof BILLING_MODE_IMAGE
  | typeof BILLING_MODE_SECOND
  | typeof BILLING_MODE_SEGMENT
